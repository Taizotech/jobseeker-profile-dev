...
import { UpdateResumeUpload } from "../apiServices";
...
const JobseekerProfileFormResume = () => {
  ...
  const openBioDataCreatedPopupMessage = (skiped) => {
    ...
    if (!skiped) {
      ...
      UpdateResumeUpload(profileFile, candidateNumber)
        .then((data) => {
        ...
        <div className={styles.bodySection}>
          ...
          <div className={styles.profilePictureContainer}>
              ...
              <div className={styles.profilePictureField}>
                ...
                {showError && (
                  <p className="text-danger">
                    {translate.PleaseUploadYourResume[Lang]}
                  </p>
                )}
                <div>
                  <div className="my-3">
                    ...
                    >
                      ...
                      {
                        translate
                          .yourChancesOfGettingJobIncreasedWithGoodResume[Lang]
                      }{" "}
                      ( PDF )
                    </p>
                  </div>
            ...
            <div className={` mt-3`}>
              ...
              >
                <span className={styles.submit}>{translate.Upload[Lang]}</span>
              </button>
              <button
...
export default JobseekerProfileFormResume;
